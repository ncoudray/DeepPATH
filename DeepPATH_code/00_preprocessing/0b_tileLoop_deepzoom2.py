...
class DeepZoomImageTiler(object):
    ...
    def xml_read(self, xmldir):
        ...
        #print(ImgMaxSizeX_orig, ImgMaxSizeY_orig, cols, rows)/ifs/home/coudrn01/NN/github/DeepPATH_code/00_preprocessing/0b_tileLoop_deepzoom2.py 
        try:
...
class DeepZoomStaticTiler(object):
    ...
    def __init__(self, slidepath, basename, format, tile_size, overlap,
                limit_bounds, quality, workers, with_viewer, Bkg, basenameJPG, xmlfile, mask_type, ROIpc):
        if with_viewer:
